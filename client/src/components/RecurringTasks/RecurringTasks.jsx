...
function RecurringTasks({recurringTask, onEdit, onDelete}) {
    ...
    const nextDeadline = getDDMM(addDays(lastCreatedDate, interval).toLocaleDateString('en-CA'))
    ...
    return (
        <div className="recTableRow">
            ...
            <div className="recTableColumn"><button onClick={onEdit}>Edit</button></div>
            <div className="recTableColumn"><button onClick={onDelete}>Delete</button></div>
        </div>
    );
}
