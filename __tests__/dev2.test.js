...
import { isTodayBirthday } from "../client/src/utilities/utilities";
...
// })
const bday1 = "2003-07-29T00:00:00"
test('tests the today birthday checker', () => {
        expect(isTodayBirthday(bday1)).toEqual(true)
})
